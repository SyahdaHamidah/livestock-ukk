...
<head>
    ...
    <link rel="manifest" href="landing/img/favicons/manifest.json">
    <meta name="msapplication-TileImage" content="landing/img/favicons/mstile-150x150.png">
...
<body>
    ...
    <main class="main" id="top">
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3 bg-light opacity-85" data-navbar-on-scroll="data-navbar-on-scroll">
            <div class="container"><a class="navbar-brand" href="index.html"><img class="d-inline-block align-top img-fluid" src="landing/img/gallery/logo-icon.png" alt="" width="50" /><span class="text-theme font-monospace fs-4 ps-2">Zou</span></a>
                ...
                <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
                    ...
                    <div class="container-login100-form-btn">
                        <a href="/log" class="btn btn-lg btn-dark bg-gradient order-0" style="margin-left: 50%; width: 120%;">Login</a>
                    </div>
                    <div class="container-login100-form-btn">
                        <a href="/regist" class="btn btn-lg btn-dark bg-gradient order-0" style="margin-left: 60%;">Register</a>
                    </div>
                </div>
            </div>
        </nav>
        <section class="py-0" id="header">
            <div class="bg-holder d-none d-md-block" style="background-image:url(landing/img/illustrations/farm.jpg);background-position:right top;background-size:contain;">
            </div>
            <!--/.bg-holder-->

            <div class="bg-holder d-md-none" style="background-image:url(landing/img/illustrations/farm.jpg);background-position:right top;background-size:contain;">
            </div>
            <!--/.bg-holder-->
            ...
            <div class="container">
                <div class="row align-items-center min-vh-75 min-vh-lg-100">
                    <div class="col-md-7 col-lg-6 col-xxl-5 py-6 text-sm-start text-center">
                        <h1 class="mt-6 mb-sm-4 fw-semi-bold lh-sm fs-4 fs-lg-5 fs-xl-6">A New Way to Invest <br class="d-block d-lg-block" />in the field of Animal Husbandry</h1>
                        <p class="mb-4 fs-1">Zou provides information application for breeders.</p><a class="btn btn-lg btn-success" href="#" role="button">Invest Now</a>
                    </div>
                </div>
            </div>
        </section>
        <section class="py-5" id="Opportuanities">
            <div class="bg-holder d-none d-sm-block" style="background-image:url(landing/img/illustrations/bg.png);background-position:top left;background-size:225px 755px;margin-top:-17.5rem;">
            </div>
            <!--/.bg-holder-->
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-5">
                                <div class="card h-100 shadow px-4 px-md-2 px-lg-3 card-span pt-6">
                                    <div class="text-center text-md-start card-hover"><img class="ps-3 icons" src="landing/img/icons/farmer.svg" height="60" alt="" />
                                        <div class="card-body">
                            ...
                            <div class="col-md-4 mb-5">
                                <div class="card h-100 shadow px-4 px-md-2 px-lg-3 card-span pt-6">
                                    <div class="text-center text-md-start card-hover"><img class="ps-3 icons" src="landing/img/icons/growth.svg" height="60" alt="" />
                                        <div class="card-body">
                            ...
                            <div class="col-md-4 mb-5">
                                <div class="card h-100 shadow px-4 px-md-2 px-lg-3 card-span pt-6">
                                    <div class="text-center text-md-start card-hover"><img class="ps-3 icons" src="landing/img/icons/planting.svg" height="60" alt="" />
                                        <div class="card-body">
                    ...
                    <div class="col-xl-9 mb-3">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-5">
                                <div class="card text-white"><img class="card-img" src="landing/img/gallery/short-terms.png" alt="..." />
                            ...
                            <div class="col-md-6 mb-5">
                                <div class="card text-white"><img class="card-img" src="landing/img/gallery/fully-funded.png" alt="..." />
        ...
        <section class="py-0">
            <div class="bg-holder" style="background-image:url(landing/img/illustrations/how-it-works.png);background-position:center bottom;background-size:cover;">
            </div>
            <!--/.bg-holder-->
            ...
            <div class="container-lg">
                <div class="row flex-center">
                    <div class="col-12 col-lg-10 col-xl-12">
                        <div class="bg-holder" style="background-image:url(landing/img/illustrations/testimonial-bg.png);background-position:top left;background-size:120px 83px;">
                        </div>
                        <!--/.bg-holder-->
                            ...
                            <div class="carousel-item active" data-bs-interval="10000">
                                <div class="row h-100 mx-3 mx-sm-5 mx-md-4 my-md-7 m-lg-7 mt-7">
                                    <div class="col-md-4 mb-5 mb-md-0">
                                        <div class="card h-100 shadow">
                                            <div class="card-body my-3">
                                                <div class="align-items-xl-center d-block d-xl-flex px-3"><img class="img-fluid me-3 me-md-2 me-lg-3" src="landing/img/gallery/user-1.png" width="50" alt="" />
                                    ...
                                    <div class="col-md-4 mb-5 mb-md-0">
                                        <div class="card h-100 shadow">
                                            <div class="card-body my-3">
                                                <div class="align-items-xl-center d-block d-xl-flex px-3"><img class="img-fluid me-3 me-md-2 me-lg-3" src="landing/img/gallery/user-2.png" width="50" alt="" />
                                                    <div class="flex-1 align-items-center pt-2">
                                    ...
                                    <div class="col-md-4 mb-5 mb-md-0">
                                        <div class="card h-100 shadow">
                                            <div class="card-body my-3">
                                                <div class="align-items-xl-center d-block d-xl-flex px-3"><img class="img-fluid me-3 me-md-2 me-lg-3" src="landing/img/gallery/user-3.png" width="50" alt="" />
                                                    <div class="flex-1 align-items-center pt-2">
        ...
        <section class="py-0" id="contact">
            <div class="bg-holder" style="background-image:url(landing/img/illustrations/footer-bg.png);background-position:center;background-size:cover;">
            </div>
            <!--/.bg-holder-->
            ...
            <div class="container">
                <div class="row justify-content-lg-between min-vh-75" style="padding-top:21rem">
                    ...
                    <div class="col-6 col-sm-4 col-lg-auto mb-3">
                        ...
                        <ul class="list-unstyled mb-md-4 mb-lg-0">
                            ...
                            <li class="mb-3"><a class="text-700 text-decoration-none" href="/log">Login</a></li>
                        </ul>
                    </div>
                    <div class="col-6 col-sm-4 col-lg-auto mb-3">
                ...
                <div class="row flex-center py-5">
                    <div class="col-12 col-sm-8 col-md-6 text-center text-md-start"> <a class="text-decoration-none" href="#"><img class="d-inline-block align-top img-fluid" src="landing/img/gallery/logo-icon.png" alt="" width="40" /><span class="text-theme font-monospace fs-3 ps-2">Zou</span></a></div>
                    <div class="col-12 col-sm-8 col-md-6">
                        <p class="fs--1 text-dark my-2 text-center text-md-end">&copy; This template is made with&nbsp;
                            ...
                            </svg>&nbsp;by&nbsp;<a class="text-dark" href="https://themewagon.com/" target="_blank">ThemeWagon </a>
                        </p>
                    </div>
                </div>
            </div>
